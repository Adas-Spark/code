...
*   Generates vector embeddings for the selected captions using a text embedding model (e.g., `llama-text-embed-v2` or similar, specified within the script or Pinecone client).
